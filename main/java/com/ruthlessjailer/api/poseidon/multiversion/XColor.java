...
public final class XColor {
	...
	public static XColor fromChatColor(@NonNull final ChatColor chatColor) {
		...
		if (!chatColor.isFormat() && MinecraftVersion.Companion.atLeast(MinecraftVersion.v1_15)) {
	...
	public static XColor fromBungee(@NonNull final net.md_5.bungee.api.ChatColor chatColor) {
		...
		if (MinecraftVersion.Companion.atLeast(MinecraftVersion.v1_15)) {
	...
	public static XColor fromDyeColor(@NonNull final DyeColor dyeColor) {
		...
		throw new IllegalStateException(dyeColor.name());
	}
	 ...
	 */
	public net.md_5.bungee.api.ChatColor getBungee() { return MinecraftVersion.Companion.atLeast(MinecraftVersion.v1_15) ? net.md_5.bungee.api.ChatColor.of(getColor()) : this.chatColor.asBungee(); }
	...
	public void applyTo(final ItemStack item, final String name) {
		...
		if (MinecraftVersion.Companion.atLeast(MinecraftVersion.v1_13)) {
			final Material material = toMaterial(name);
			item.setType(material == null ? def : material);
			return;
		}

		if (MinecraftVersion.Companion.atMost(MinecraftVersion.v1_12)) {
	...
	public Material toMaterial(final String name) {
		...
		if (MinecraftVersion.Companion.lessThan(MinecraftVersion.v1_13)) {
			return null;
		}
