...
class SyncTaskManager : TaskManager {
	 ...
	 */
	override fun delay(runnable: Runnable, delay: Int): BukkitTask = Bukkit.getScheduler().runTaskLater(PluginBase.instance, runnable, delay.toLong())
	 ...
	 * @return the [BukkitTask] representing the task
	 */
	override fun repeat(runnable: Runnable, interval: Int): BukkitTask = Bukkit.getScheduler().runTaskTimer(PluginBase.instance, runnable, interval.toLong(), interval.toLong())
	 ...
	 * @return the [BukkitTask] representing the task
	 */
	override fun delay(bukkit: BukkitRunnable, delay: Int): BukkitTask = bukkit.runTaskLater(PluginBase.instance, delay.toLong())
	 ...
	 * @return the [BukkitTask] representing the task
	 */
	override fun repeat(bukkit: BukkitRunnable, interval: Int): BukkitTask = bukkit.runTaskTimer(PluginBase.instance, interval.toLong(), interval.toLong())
